...
class AppTypography {
  ...
  static TextTheme textTheme(ColorScheme colorScheme) {
    ...
    final montserrat = base.apply(fontFamily: _fontFamily);

    final themed = montserrat.copyWith(
      headlineLarge: _override(
        montserrat.headlineLarge,
        colorScheme,
        weight: FontWeight.w700,
        letterSpacing: 0.3,
      ),
      titleLarge: _override(
        montserrat.titleLarge,
        colorScheme,
        weight: FontWeight.w600,
        letterSpacing: 0.15,
      ),
      bodyMedium: _override(
        montserrat.bodyMedium,
        colorScheme,
        weight: FontWeight.w400,
      ),
      bodySmall: _override(montserrat.bodySmall, colorScheme),
      labelLarge: _override(
        montserrat.labelLarge,
        colorScheme,
        weight: FontWeight.w600,
        letterSpacing: 0.4,
      ),
